    ...
    if (this.state.on && this.state.user_data === null) {
      return (
        <div className="github_component">
          <div className="gh_on">
            <p className="gh_title title gh_hide" onClick={this.handleClick}>
              Hide
            </p>
            <input
            ...
            />
            <div className="save_gh_input  title" onClick={this.saveInput}>
              Save
            </div>
          </div>
        </div>
      ...
      return (
        <div className="github_component">
          <div className="gh_on">
            ...
            <a href={this.state.user_data.url} target="_blank">
              <img
                src={this.state.user_data.av}
                className="gh_av"
                alt=""
                target="_blank"
              />
            ...
            <ul className="user_data_ul">
              <h5>
                {this.state.display_username}{' '}
                <img
                  className="gh_change_user"
